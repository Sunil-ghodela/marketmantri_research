...
- **Scope discipline (new, from #2's note):** a portfolio Sharpe is only
  ...
  46 names with no concurrency cap; the live engine runs 15 slots. Row #10 measures
  that cap directly: roughly Sharpe-neutral, so it is ruled out as the live-gap cause.
